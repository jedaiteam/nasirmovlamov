...
<h4>Text Editors I liked to use</h4>
    <div><pre><img src='https://upload.wikimedia.org/wikipedia/commons/e/e2/Atom_1.0_icon.png' width='50px' height='30px'/>  <img src='https://cdn.worldvectorlogo.com/logos/visual-studio-code.svg' width='30px' height='30px'/>  <img src='https://cdn.worldvectorlogo.com/logos/sublime-text.svg' width='30px' height='30px'/></pre></div>
