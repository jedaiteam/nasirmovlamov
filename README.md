...
<h4>Text Editors I liked to use</h4>
    <div><pre><img src='https://static.vecteezy.com/system/resources/previews/000/330/387/non_2x/vector-atom-flat-multi-color-icon.jpg' width='30px' height='30px'/>  <img src='https://cdn.worldvectorlogo.com/logos/visual-studio-code.svg' width='30px' height='30px'/>  <img src='https://cdn.worldvectorlogo.com/logos/sublime-text.svg' width='30px' height='30px'/></pre></div>
